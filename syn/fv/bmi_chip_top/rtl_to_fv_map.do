...
# Generated on: Sun May 31 21:15:59 CDT 2026 (Mon Jun 01 02:15:59 GMT 2026)

set lec_version [regsub {(-)[A-Za-z]} $env(LEC_VERSION) ""]

tcl_set_command_name_echo on

set_log_file fv/bmi_chip_top/rtl_to_fv_map.log -replace

usage -auto -elapse

set_verification_information rtl_fv_map_db

read_implementation_information fv/bmi_chip_top -revised fv_map
...
read_library -liberty -both   /vol/eecs391/GPDK045/gsclib045_all_v4.8/gsclib045/timing/slow_vdd1v0_basicCells.lib
...
read_design -enumconstraint  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -sv09 ../rtl/sample_collection.sv
add_search_path . -design -golden
read_design -enumconstraint  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -sv09 ../rtl/sbp_feature_extractor.sv
add_search_path . -design -golden
read_design -enumconstraint  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -sv09 ../rtl/mlp_inference.sv
add_search_path . -design -golden
read_design -enumconstraint  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -sv09 ../rtl/argmax.sv
add_search_path . -design -golden
read_design -enumconstraint  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -sv09 ../rtl/output_formatter.sv
add_search_path . -design -golden
read_design -enumconstraint  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -sv09 ../rtl/spi_slave.sv
add_search_path . -design -golden
read_design -enumconstraint  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -sv09 ../rtl/bmi_chip_top.sv
elaborate_design -golden -root {bmi_chip_top} -rootonly -rootonly  

read_design -verilog95   -revised -lastmod -noelab fv/bmi_chip_top/fv_map.v.gz
elaborate_design -revised -root {bmi_chip_top}
...
#add_name_alias fv/bmi_chip_top/fv_map.singlebit.original_name.alias.json.gz -revised
